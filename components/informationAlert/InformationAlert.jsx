        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            <Typography variant="subtitle" gutterBottom color='#828282'>
                Los partidos disponibles corresponden a la primera división de Inglaterra, Italia, España, Alemania, Francia, y Portugal. Además, partidos del mundial, Champions League y Eurocopa.
            </Typography>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
